(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-search-users-search-users-module~modules-view-edit-user-view-edit-user-module"],{
...
/***/ "HT8n":
/*!**********************************************************************!*\
  !*** ./src/app/modules/search-users/services/search-user.service.ts ***!
  \**********************************************************************/
...
class SearchUserService {
    constructor(http) {
        this.http = http;
        this._urlUser = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].urlService}/users`;
    }
    getAllUserHttpResponse(filtro) {
    ...
    getAllUser(filtro) {
        return this.getAllUserHttpResponse(filtro).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => response.body));
    }
    getUserId(id) {
        return this.http.get(`${this._urlUser}/${id}`, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => response.body));
    }
    postNewUser(user) {
        return this.http.post(`${this._urlUser}`, user, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => response.body));
    }
    setUser(user) {
        return this.http.put(`${this._urlUser}/${user.id}`, user, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => response.body));
    }
    deleteUser(id) {
        return this.http.delete(`${this._urlUser}/${id}`, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(response => response.body));
    }
}
SearchUserService.ɵfac = function SearchUserService_Factory(t) { return new (t || SearchUserService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); };
SearchUserService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({ token: SearchUserService, factory: SearchUserService.ɵfac, providedIn: 'root' });
...
/***/ "NyM5":
/*!****************************************************************!*\
  !*** ./src/app/modules/search-users/services/modal.service.ts ***!
  \****************************************************************/
...
//# sourceMappingURL=default~modules-search-users-search-users-module~modules-view-edit-user-view-edit-user-module.js.map